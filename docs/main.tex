...
A subset is randomly chosen, and the best is selected. Say you have a population of $x$ agents. When using tournament selection before crossover, the population will be divided into subsets. $tournament_count = x/tournament_size$ Inside each tournament the best performing agent will be chosen for reproduction. 
